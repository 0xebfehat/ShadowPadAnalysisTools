...
''' Pattern 
data:0000000140060B5D 48 81 FC 70 49 00 00    cmp     rsp, 4970h
...
def deobs_opaque_predicate(searchPattern, startAddress, endAddress):
    ...
    while emu_start < endAddress:
        ...
        emu_start = idc.next_head(emu_start, idc.get_segm_end(startAddress))
